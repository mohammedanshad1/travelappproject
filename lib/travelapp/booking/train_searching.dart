      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TrainSearchField(
                icon: Icons.output, label: 'Kasargod', iconColor: Colors.red),
            TrainSearchField(
...
class TrainSearchField extends StatelessWidget {
  final IconData icon;
  final String label;
...
class SearchTrainsButton extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        ServiceItem(icon: Icons.book, label: 'Platform Ticket'),
        ...
        ServiceItem(icon: Icons.local_taxi, label: 'Cabs'),
      ],
    );
  }
}
