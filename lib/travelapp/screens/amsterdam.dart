...
class _AmsterdamState extends State<Amsterdam> {
  ...
  Widget build(BuildContext context) {
    ...
    var trip = trips.isNotEmpty ? trips[7] : null; // Get the first trip or null
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text(
                      "Amsterdam, the capital city of the Netherlands, is renowned for its picturesque canals, historic architecture, and vibrant cultural scene. Founded in the late 12th century as a small fishing village on the Amstel River.",
                      style: TextStyle(
                        fontFamily: "Sora",
