...
class _ChinaState extends State<China> {
  ...
  Widget build(BuildContext context) {
    ...
    var trip = trips.isNotEmpty ? trips[3] : null; // Get the first trip or null
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text(
                      "China, a vast and diverse country, is a tapestry of ancient traditions, modern marvels, and breathtaking landscapes. With a history spanning over 5,000 years, China boasts iconic landmarks such as the Great Wall.",
                      style: TextStyle(
                        fontFamily: "Sora",
