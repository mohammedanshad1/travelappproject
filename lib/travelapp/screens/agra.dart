...
class Agra extends StatefulWidget {
  const Agra({Key? key}) : super(key: key);
...
class _AgraState extends State<Agra> {
  ...
  Widget build(BuildContext context) {
    ...
    var trip = trips.isNotEmpty ? trips[6] : null; // Get the first trip or null
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text(
                      "Agra, located in the northern Indian state of Uttar Pradesh, is a city of immense historical and cultural significance. It is famously home to the Taj Mahal, one of the Seven Wonders of the World and a UNESCO World Heritage site.",
                      style: TextStyle(
                        fontFamily: "Sora",
